...
<c:import url="/Api/admgrIncludeLeftMenu.do"/>
		...
		<div id="content">
			...
			<%--
			<!-- 상품관리 > 숙박 > 리스트 > 상품관리 { -->
			<section id="productRoomList" class="page_content">
				<!-- 리스트 검색 { -->
				...
				<nav id="tab-gnb" class="mgt20px">
					<ul class="nopm floats">
						<li class="active"><a href="./product_room_list.php">상품관리</a></li>
						<li><a href="./product_room_dp.php">진열관리</a></li>
					...
					<tbody>
						<tr>
							...
							<td class="alignCenter">
								<a href="/admgr/admgrProduct/productRoomForm.do" class="btns bluebtn h24px">수정</a>
				...
				<div class="btnarea alignRight mgt30px">
					<a href="/admgr/admgrProduct/productForm.do?store_category=<c:out value="${store_category }"/>" class="btns redbtn"><i class="fal fa-pencil-alt"></i> 숙박 등록</a>
				</div>
			</section>
			<!-- } 상품관리 > 숙박 > 리스트 > 상품관리 -->
		</div>
