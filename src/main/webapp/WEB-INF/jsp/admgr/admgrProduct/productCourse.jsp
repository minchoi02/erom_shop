		...
		<div id="content">
			...
			<section id="courseList" class="page_content">
				...
				<nav id="tab-gnb" class="mgt20px">
					<ul class="nopm floats">
						<li class="active"><a href="/admgr/admgrProduct/productList.do?pageIndex=1&store_category=<c:out value="${store_category }"/>&searchKey=<c:out value="${searchKey}"/>&searchKeyword=<c:out value="${searchKeyword }"/>">상품관리</a></li>
						<li><a href="/admgr/admgrProduct/productOrderbyList.do?pageIndex=1&store_category=<c:out value="${store_category }"/>&searchKey=<c:out value="${searchKey}"/>&searchKeyword=<c:out value="${searchKeyword }"/>">진열관리</a></li>
						<li class="fr"><a href="/admgr/admgrProduct/productEndList.do?pageIndex=1&store_category=<c:out value="${store_category }"/>&searchKey=<c:out value="${searchKey}"/>&searchKeyword=<c:out value="${searchKeyword }"/>"><span class="colorRed">노출중지</span></a></li>
					</ul>
				</nav>
				<!-- } 탭 버튼 -->
				...
				<div class="btnarea alignRight mgt30px">
					<a href="/admgr/admgrProduct/productForm.do?store_category=<c:out value="${store_category }"/>" class="btns redbtn"><i class="fal fa-pencil-alt"></i> 추천여행상품 등록</a>
				</div>
			</section>
			<!-- } 추천여행상품 > 리스트 > 상품관리 -->
		</div>
