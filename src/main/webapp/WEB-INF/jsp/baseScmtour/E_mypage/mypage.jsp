    ...
    <div id="mypage" class="buyList">
    	<div class="inner detailTop">
            ...
            <div class="right">
                ...
                <ul id="mypage-tab">
                    <li class="on"><a href="/mypage.do">구매내역</a></li>
                    <li><a href="/mypage_cancel.do">취소/반품/교환 내역</a></li>
                </ul>
                <div class="buyList-detail">
                    ...
                    <div class="buyList-detail-list">
                        ...
                        <div class="listArea">
                        	<div class="codeNum">
                            	2022-06-04<br class="pc-style">(441543054)<br class="pc-style"><a href="/mypage_detail.do"><button class="btn">상세보기</button></a>
                            </div>
                            <div class="bundle">
                            	<div>
                                    ...
                                    <span class="deli ltgreen">배송중</span>
                                </div>
                                <div>
                                    <div class="imgArea"><a href=""><img src="/resource/img/po_product_img4.jpg" /></a></div>
                                    <div class="subject">
