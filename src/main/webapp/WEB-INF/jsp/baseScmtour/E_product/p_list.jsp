    ...
    <div id="container">
        ...
        <div class="product-list">
            <div class="inner clearfix">
                <ul id="tab2">                
                <li <c:if test="${prod_content_precautions eq null || prod_content_precautions eq ''}"> class="on"</c:if>><a href="/p_list.do">전체</a></li>
					<li <c:if test="${prod_content_precautions eq tgList.base_tg_cd_4_1}"> class="on"</c:if>><a href="/p_list.do?prod_content_precautions=<c:out value="${tgList.base_tg_cd_4_1 }"/>"><c:out value="${tgList.base_tg_cd_4_1 }"/></a></li>
                    <li <c:if test="${prod_content_precautions eq tgList.base_tg_cd_4_2}"> class="on"</c:if>><a href="/p_list.do?prod_content_precautions=<c:out value="${tgList.base_tg_cd_4_2 }"/>"><c:out value="${tgList.base_tg_cd_4_2 }"/></a></li>
                    <li <c:if test="${prod_content_precautions eq tgList.base_tg_cd_4_3}"> class="on"</c:if>><a href="/p_list.do?prod_content_precautions=<c:out value="${tgList.base_tg_cd_4_3 }"/>"><c:out value="${tgList.base_tg_cd_4_3 }"/></a></li>
                    <li <c:if test="${prod_content_precautions eq tgList.base_tg_cd_4_4}"> class="on"</c:if>><a href="/p_list.do?prod_content_precautions=<c:out value="${tgList.base_tg_cd_4_4 }"/>"><c:out value="${tgList.base_tg_cd_4_4 }"/></a></li>
                </ul>
                </ul>
                </ul>
                </ul>
