...
%>
<c:set var="authday" value="${authday }"/>
<%
String Birth = sBirthDate;
String AuthYear = (String) pageContext.getAttribute("authday"); 
int authCheck = Integer.parseInt(AuthYear) - Integer.parseInt(Birth);
if(authCheck < 0) {
%>
<script>alert("해당 상품은 만 19세이상 주문이 가능합니다."); self.window.close();</script>
<% } else { %>
<script>alert("인증완료"); location.href="/shop/adultSession.do";</script>
<% } %>
